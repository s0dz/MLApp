...
namespace MLAppML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\gmctear.JANECORP\dev_me\MLApp\MLApp\deal-reviews.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\gmctear.JANECORP\AppData\Local\Temp\MLVSTools\MLAppML\MLAppML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Text.FeaturizeText("Body_tf", "Body")
                                      .Append(mlContext.Transforms.CopyColumns("Features", "Body_tf"))
                                      .Append(mlContext.Transforms.NormalizeMinMax("Features", "Features"))
                                      .AppendCacheCheckpoint(mlContext);
            // Set the training algorithm 
            var trainer = mlContext.BinaryClassification.Trainers.SymbolicSgdLogisticRegression(labelColumnName: "Sentiment", featureColumnName: "Features");
